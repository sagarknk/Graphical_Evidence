...
1. GHS_graphical_evidence.m --> This matlab file implements our proposed procedure according to
...
"GHS_Hao_wang.m" to run the unrestricted MCMC sampler in the evaluation of the term IV_j. Next,
it calls "GHS_last_col_fixed.m" to run the restricted MCMC sampler in the evaluation of the term
